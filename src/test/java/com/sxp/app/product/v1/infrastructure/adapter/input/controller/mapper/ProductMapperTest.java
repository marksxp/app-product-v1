...
class ProductMapperTest {
    ...
    void givenProductDomain_WhenCalled_ShouldReturnProduct() {
        ...
        assertEquals(product.getProductId(), productDomain.getProductId());
        assertEquals(product.getBrandId(), productDomain.getBrandId());
        assertEquals(product.getPriceList(), productDomain.getPriceList());
        assertEquals(product.getStartDate(), productDomain.getStartDate());
        assertEquals(product.getEndDate(), productDomain.getEndDate());
        assertEquals(product.getPrice(), productDomain.getPrice());
