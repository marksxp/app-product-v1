...
class ProductServiceTest {
    ...
    void givenProductInDatabase_WhenCalled_ShouldReturnData() {
        ...
        when(productH2ServicePort.findProductByFields(any(), any(), any())).thenReturn(Mono.just(productDomain));

        var result = productService.retrieveProducts(any(), any(), any());
    ...
    void givenNoProductInDatabase_WhenCalled_ShouldReturnEmpty() {
        when(productH2ServicePort.findProductByFields(any(), any(), any())).thenReturn(Mono.empty());
